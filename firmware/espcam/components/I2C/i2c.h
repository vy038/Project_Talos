...
// i2c master configuration (ESP-CAM board)
// camera SCCB uses GPIO 26/27 internally, so TOF uses separate pins
#define I2C_MASTER_SCL_IO   GPIO_NUM_41
#define I2C_MASTER_SDA_IO   GPIO_NUM_40
 ...
 * @param dev_addr  7-bit I2C address (0x29 for VL53L0X)
